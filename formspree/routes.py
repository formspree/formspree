...
def configure_routes(app):
    ...
    app.add_url_rule('/unconfirm/<form_hashid>', 'request_unconfirm_form', view_func=fv.request_unconfirm_form, methods=['GET'])
    app.add_url_rule('/unconfirm/multiple', 'unconfirm_multiple', view_func=fv.unconfirm_multiple, methods=['POST'])
    app.add_url_rule('/unconfirm/<digest>/<form_hashid>', 'unconfirm_form', view_func=fv.unconfirm_form, methods=['GET', 'POST'])
