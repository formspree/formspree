...
def configure_routes(app):
    ...
    app.add_url_rule('/form/<hashid>/delete', 'form-deletion', view_func=forms.views.form_deletion, methods=['GET'])
    app.add_url_rule('/form/<hashid>/<submissionid>/delete', 'submission-deletion', view_func=forms.views.submission_deletion, methods=['GET'])
