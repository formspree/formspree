...
def configure_routes(app):
    ...
    app.add_url_rule('/<email>', 'resend_confirmation', view_func=forms.views.resend_confirmation, methods=['GET', 'POST'])
    ...
    app.add_url_rule('/account/confirm', 'notify-email-confirmation', view_func=users.views.notify_email_confirmation, methods=['GET'])
